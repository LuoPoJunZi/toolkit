...
main() {
  ...
  assert_contains_fixed "$LUOPO_SYSTEM_TOOLS_ACTIONS_FILE" 'luopo_system_tools_launch_compat' "system tools should retain compat fallback"
  ...
  assert_contains_fixed "$LUOPO_SYSTEM_TOOLS_ACTIONS_FILE" '66) run_luopo_compat_menu linux_Settings 66 ;;' "system tools dispatch should route one-click tuning via targeted compat"
